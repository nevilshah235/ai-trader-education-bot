...
// In a monorepo, deps are hoisted to root
...
const config: Config = {
    ...
    moduleDirectories: ['node_modules', 'bower_components', 'shared', rootNodeModules],
    ...
    moduleNameMapper: {
        ...
        '@deriv-com/ui': path.join(rootNodeModules, '@deriv-com/ui'),
